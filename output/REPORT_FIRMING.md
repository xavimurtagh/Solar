# Firming the Sun: The Real Cost of 24/7 Solar
...
reliable round-the-clock solar costs **$72/MWh** — inside
...
moderate site roughly **1.7×** the cost ($104 →
$173/MWh), because covering rare multi-day cloudy lulls needs enormous,
...
- Single battery (one round-trip efficiency, no degradation/augmentation), one
  ...
  capital-recovery factor (discount 6%,
  25-yr life).
